...
const Main = (props) => {
    ...
    const fetchRestaurant = async () => {
        ...
        //     alttaki de olabilir
        // const {data} = await axios.get('https://random-data-api.com/api/restaurant/random_restaurant');
    ...
    // async function fetchData_Await() {
    //     normal fonksiyonlarda async bu şekilde yazılır
    // }
